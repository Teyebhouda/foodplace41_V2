        ...
        <div id="container_details">
			...
			<div class="table-responsive">
                ...
                <?php if(auth('clientRestaurant')->check()): ?>
                    ...
                    <form id="checkoutForm"  method="POST" action="<?php echo e(route('client.checkout1.store', ['subdomain' => $subdomain ])); ?>"  class="check-validation">
                        <?php echo csrf_field(); ?>
...
function validateForm() {
    ...
    return true; // Allow form submission
            ...
            <div id="accountFields" style="display: none;">
              ...
              <p>Vous avez déjà un compte? <a href="<?php echo e(route('client.login', ['subdomain' => $subdomain])); ?>">Connexion</a> </p>    
				  <div class="form-group">
...
<script>
   ...
   $(document).ready(function () {
    ...
    fetch('<?php echo e(route("update.quantity",["subdomain" => $subdomain])); ?>', {
        method: 'POST',
        headers: {
 ...
 $(document).ready(function () {
    ...
    $checkform.on('submit', function (e) {
        ...
        if (dataMethod === "Carte Bancaire") {
			...
			//var dataMethod = selectedOption.getAttribute('data-method');
var url = '<?php echo e(route("make.payment", ["subdomain" => $subdomain, "paymentMethodId" => ":paymentMethodId"])); ?>';
...
var routeUrl = '<?php echo e(route("stripe.post", ["subdomain" => $subdomain, "paymentMethodId" => ":paymentMethodId"])); ?>';
...
<?php /**PATH C:\inetpub\vhosts\foodexpress.site\xn--OrlandosCaf-lbb.foodexpress.site\resources\views/client/checkout.blade.php ENDPATH**/ ?>