...
<?php endif; ?>
        ...
        <ul class="navbar-nav">
          <li class="menu-item">
            <a href="<?php echo e(url('/store')); ?>"style="color: white; font-size: 20px;">Menu</a>
          </li>
          ...
          <li class="menu-item">
            <a href="<?php echo e(url('/reservationtables')); ?>" style="color: white; font-size: 20px;">Réserver une Table</a>
          </li>
          <?php endif; ?>
         <?php endif; ?> 
...
<?php endif; ?><?php /**PATH C:\inetpub\vhosts\foodexpress.site\xn--OrlandosCaf-lbb.foodexpress.site\resources\views/client/layouts/header_menu.blade.php ENDPATH**/ ?>