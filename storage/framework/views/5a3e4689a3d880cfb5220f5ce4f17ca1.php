...
<div class="container">
	...
	<br>
        ...
        <p>Si vous avez des questions ou des commentaires concernant notre Politique de Cookies, veuillez nous contacter à l'adresse e-mail suivante : <b><?php echo e($user->email); ?>.</p>
    </div>
	<br>
	<br>
</div>
...
<?php echo $__env->make('client.layouts.top_menu_client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\inetpub\vhosts\foodexpress.site\xn--OrlandosCaf-lbb.foodexpress.site\resources\views/client/politique-de-cookies.blade.php ENDPATH**/ ?>