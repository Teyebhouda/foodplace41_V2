...
unset($__errorArgs, $__bag); ?>
    ...
    <input id="password" type="password" class="form-control form-control-light" name="password" placeholder="Mot de passe"  autocomplete="new-password" required minlength="8">
            ...
            <p>Vous avez déjà un compte? <a href="<?php echo e(route('client.login')); ?>">Se connecter</a> </p>
  ...
  <!-- Footer Start -->
  <?php echo $__env->make('client.layouts.footer_client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\teyeb\laravel dev\Foodplace-v2\foodplace41_V2\resources\views/client/register.blade.php ENDPATH**/ ?>