...
<footer class="ct-footer footer-dark position-relative pt-8  z-1 overflow-hidden gshop-footer">
	 <img src="<?php echo e(asset('assetsClients/img/footer/shape-13.png')); ?>" alt="tomato"
        class="position-absolute z--1 tomato vector-shape">
    <img src="<?php echo e(asset('assetsClients/img/footer/shape-5.png')); ?>" alt="pata"
        class="position-absolute z--1 pata-lg vector-shape">
    <img src="<?php echo e(asset('assetsClients/img/footer/shape-30.png')); ?>" alt="pata"
        class="position-absolute z--1 pata-xs vector-shape">
    <img src="<?php echo e(asset('assetsClients/img/footer/shape-14.png')); ?>" alt="frame"
        class="position-absolute z--1 frame-circle vector-shape">
    <img src="<?php echo e(asset('assetsClients/img/footer/shape-31.png')); ?>" alt="leaf"
        class="position-absolute z--1 leaf vector-shape">
    <!--shape right -->
    <img src="<?php echo e(asset('assetsClients/img/footer/shape-25.png')); ?>" alt="pata"
        class="position-absolute leaf-2 z--1 vector-shape">
    <img src="<?php echo e(asset('assetsClients/img/footer/shape-10.png')); ?>" alt="pata"
        class="position-absolute pata-xs-2 z--1 vector-shape">
    <img src="<?php echo e(asset('assetsClients/img/footer/shape-17.png')); ?>" alt="tomato slice"
        class="position-absolute tomato-slice vector-shape z--1">
    <img src="<?php echo e(asset('assetsClients/img/footer/shape-11.png')); ?>" alt="tomato"
    ...
    <div class="footer-widget">
      ...
      <ul style="Color:#ababac;" class="footer-nav">
        <li>Lundi: 10:00 - 15:00, 19:00 - 22:00</li>
        <li>Mardi: 10:00 - 15:00, 19:00 - 22:00</li>
        <li>Mercredi: 10:00 - 15:00, 19:00 - 22:00</li>
        <li>Jeudi: 10:00 - 15:00, 19:00 - 22:00</li>
        <li>Vendredi: 10:00 - 15:00, 19:00 - 22:30</li>
        <li>Samedi: 18:00 - 22:30</li>
    ...
    <div class="footer-bottom">
      <div class="container">
        ...
        <div class="footer-copyright">
          <p> Copyright &copy; 2024 <a href="#">Cipher Link</a> Tous droits réservés. </p>
  ...
  <script src="<?php echo e(asset('assetsClients/js/plugins/jquery-3.4.1.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assetsClients/js/plugins/popper.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assetsClients/js/plugins/waypoint.js')); ?>"></script>
  <script src="<?php echo e(asset('assetsClients/js/plugins/bootstrap.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assetsClients/js/plugins/jquery.magnific-popup.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assetsClients/js/plugins/jquery.slimScroll.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assetsClients/js/plugins/imagesloaded.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assetsClients/js/plugins/jquery.steps.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assetsClients/js/plugins/jquery.countdown.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assetsClients/js/plugins/isotope.pkgd.min.js')); ?>"></script>
  <script src="<?php echo e(asset('assetsClients/js/plugins/slick.min.js')); ?>"></script>
 <script src="<?php echo e(asset('assetsClients/js/plugins/jquery.slimScroll.min.js')); ?>"></script>

  <script src="<?php echo e(asset('assetsClients/js/main.js')); ?>"></script>
<script>
...
<?php /**PATH C:\inetpub\vhosts\foodexpress.site\xn--OrlandosCaf-lbb.foodexpress.site\resources\views/client/layouts/footer_client.blade.php ENDPATH**/ ?>