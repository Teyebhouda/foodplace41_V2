...
<div class="popup-content">
    ...
    <form method="POST" action="<?php echo e(route('validate.postal.code')); ?>">
        <?php echo csrf_field(); ?>
    ...
    <a href="javascript:void(0);" class="current-location-button">Utiliser lieu actuel</a>
        ...
        <p class="error-message"><?php echo e(session('codeError')); ?></p>
        <?php elseif(session('showPopup') === false): ?>
        <?php
...
"Nous sommes désolés, mais l'adresse que vous avez fournie se trouve en dehors de notre zone de service. Pour toute question ou pour passer une commande ."            </p>
            <p class="error-message" style="color: #333; font-size: 14px; margin: 10px 0;">
                Veuillez contacter le restaurant au numéro suivant : <?php echo e($phoneNum1); ?>

            </p>
            <?php if(!empty($email)): ?>
                <p class="email-message" style="color: #333; font-size: 14px; margin: 10px 0;">
                   Ou à l'adresse e-mail : <b><?php echo e($email); ?></b>
                </p>
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        <?php if(session('codeError')): ?>
            errorMessage.innerText = "<?php echo e(session('codeError')); ?>";
            errorMessage.style.display = "block"; // Show the error message
        <?php endif; ?>
    });
</script>
<?php /**PATH C:\Users\teyeb\laravel dev\Foodplace-v2\foodplace41_V2\resources\views/client/layouts/popup_client.blade.php ENDPATH**/ ?>