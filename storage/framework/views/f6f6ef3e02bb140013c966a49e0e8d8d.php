...
function editCart(cartItem) {
    ...
    $.ajax({
      url: '<?php echo e(route("cart.edit")); ?>',
      method: 'POST',
      data: {
        cartItem: cartItem,
...
function updateCartSidebar() {
  ...
  $('body').addClass('disable-interaction');
    ...
    $.ajax({
      url: '<?php echo e(route("cart.fetch")); ?>',
      method: 'GET',
      success: function(response) {
...
totalPriceElement.text(response.totalPrice + '€');
  ...
  <!-- Newsletter End -->
  <?php echo $__env->make('client.layouts.footer_client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\teyeb\laravel dev\Foodplace-v2\foodplace41_V2\resources\views/client/index.blade.php ENDPATH**/ ?>