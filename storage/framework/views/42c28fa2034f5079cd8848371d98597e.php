...
<div class="container mt-5">
    ...
    <p>Raison sociale : <b><?php echo e($client->name); ?> </b><br>
    Adresse du siège social : <b><?php echo e($client->localisation); ?> </b><br>
    Numéro de téléphone : <b><?php echo e($client->phoneNum1); ?> </b><br>
    Adresse e-mail : <b><?php echo e($user->email); ?></b><br>
    Numéro d'inscription au registre du commerce : <b><?php echo e($client->N_Siret); ?> </b> </p>
    ...
    <p>Tous les contenus de ce site web, tels que textes, images, logos, vidéos, etc., sont la propriété exclusive de <b><?php echo e($client->name); ?> </b> ou sont utilisés avec autorisation. Toute reproduction, distribution ou utilisation non autorisée de ces contenus est strictement interdite.</p>
...
<?php /**PATH C:\inetpub\vhosts\foodexpress.site\xn--OrlandosCaf-lbb.foodexpress.site\resources\views/client/mentions-legales.blade.php ENDPATH**/ ?>