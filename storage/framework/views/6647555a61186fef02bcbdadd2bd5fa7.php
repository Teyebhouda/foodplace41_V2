      ...
      <div class="auth-wrapper">
        ...
        <div class="auth-description bg-cover bg-center dark-overlay dark-overlay-2" style="background-image: url('assets/img/reserver_une_table.jpg')">
          <div class="auth-description-inner">
		   ...
		   <form method="post" action="<?php echo e(route('reservation.client.store', ['subdomain' => $subdomain])); ?>">
   ...
   addToCartBtn.data('table-id', selectedTableId);
       ...
       addToCartBtn.on('click', function() {
        ...
        var date = $('#date').val();
                ...
                $.ajax({
                    url: '<?php echo e(route("reservation.client.store", ["subdomain" => $subdomain])); ?>',
                    method: 'POST',
                    data: {
                    table_id: tableId,
                    nbre_personnes: nbrePersonnes,
...
<?php /**PATH C:\inetpub\vhosts\foodexpress.site\xn--OrlandosCaf-lbb.foodexpress.site\resources\views/client/reservation.blade.php ENDPATH**/ ?>