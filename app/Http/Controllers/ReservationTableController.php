...
class ReservationTableController extends Controller
{
	...
	//	dd($client);
        return view('client.reservation', compact('client', 'cart', 'livraisons','clientRestaurant'));
        }
...
$ClientFName = $request->Nom . ' ' . $request->Prénom;
      // dd($client);
        // Redirect to the reservation index page or another appropriate location
       return view('client.booking_success', compact('client', 'cart', 'livraisons', 'ClientFName'));
